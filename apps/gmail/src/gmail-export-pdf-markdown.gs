/**
 * Title: Gmail PDF and Markdown Export
 * Service: Gmail
 * Purpose: Export Gmail messages as PDF and Markdown files with spreadsheet summary
 * Created: 2023-01-01
 * Updated: 2025-07-16
 * Author: Kevin Lappe
...
/*
Script Summary:
- Purpose: Search Gmail, export messages as PDF/Markdown, create summary spreadsheet
- Description: Comprehensive email export tool with custom UI, search parameters, and file organization
- Problem Solved: Manual email archiving and document creation from Gmail messages
- Successful Execution: Creates organized folder structure with PDF/Markdown files and tracking spreadsheet
