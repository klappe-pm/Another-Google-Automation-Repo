...
function sortTabs() {
  ...
  // Define tabs to skip
  var tabsToSkip = ["gmail labels", "labels to reprocess", "labels to process", "processed"];
  ...
  for (var i = 0; i < sheets.length; i++) {
    ...
    var threadId = sheet.getRange("A2").getValue().toString();
    var dateReceived = sheet.getRange("C2").getValue();
    var timeReceived = sheet.getRange("D2").getValue();
