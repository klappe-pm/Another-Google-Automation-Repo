...
]; // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = // CONFIGURATION LOADER // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = / *  *  * Loads all configuration from the Config sheet. * This makes the script completely data - driven. *  * @returns {Object} Configuration object with all settings. * @throws {Error} If the Config sheet is missing or contains invalid JSON. *//  / = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = // MAIN GENERATOR FUNCTION // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = / *  *  * Main function that reads configuration and processes the data sheet to create files. * This is the primary entry point triggered by the user. *//  / = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = // DATA PROCESSING // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = / *  *  * Processes all valid rows in the data sheet. *  * @param {GoogleAppsScript.Spreadsheet.Sheet} sheet The sheet containing the data to process. * @param {Object} config The configuration object. * @param {Object} folderCache A cache to store Drive Folder objects for this run. * @returns {{created: number, errors: number}} An object with counts of created files and errors. *// *  *  * Updates the spreadsheet in batches for better performance. *  * @param {GoogleAppsScript.Spreadsheet.Sheet} sheet The sheet to update. * @param {Array < Object > } updates An array of update objects. * @param {Object} config The configuration object. * @param {Object} colMap The column name to index map. *//  / = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = // CONTENT GENERATION // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = / *  *  * Generates the full markdown content for a single row based on configuration. * Applies specific formatting rules to YAML values. *  * @param {Array < any > } row The data for the current row. * @param {Object} colMap The column name to index map. * @param {Object} config The configuration object. * @returns {string} The complete markdown content as a string. *// *  *  * Generates a single markdown section. *  * @param {Object} section The configuration for the section. * @param {Array < any > } row The data for the current row. * @param {Object} colMap The column name to index map. * @param {Object} config The global configuration object. * @returns {string} The markdown for the generated section. *//  / = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = // FILE OPERATIONS // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = / *  *  * Creates a file in Drive, managing subfolders and handling duplicates. *  * @param {string} filename The desired name for the file (without extension). * @param {string} content The content of the file. * @param {Object} config The configuration object. * @param {Array < any > } row The data for the current row, used for subfolder lookup. * @param {Object} colMap The column name to index map. * @param {Object} folderCache A cache holding the parent and subfolder Drive objects. * @returns {GoogleAppsScript.Drive.File} The newly created file object. * @throws {Error} If the parent Drive folder is inaccessible. *// *  *  * Gets a subfolder by name, or creates it if it doesn't exist. *  * @param {GoogleAppsScript.Drive.Folder} parentFolder The parent folder to search within. * @param {string} name The name of the subfolder to find or create. * @returns {GoogleAppsScript.Drive.Folder} The existing or newly created subfolder. *//  / = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = // HELPER FUNCTIONS // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = / *  *  * Creates a mapping of column header names to their zero - based index. *  * @param {Array < string > } headers An array of header strings from the sheet. * @param {Object} customMapping A mapping of sheet headers to desired keys. * @returns {Object} A map where keys are column names and values are their indices. *// *  *  * Ensures a column for status messages exists, creating it if necessary. *  * @param {GoogleAppsScript.Spreadsheet.Sheet} sheet The sheet to check. * @param {Object} config The configuration object containing the status column name. *// *  *  * Converts a string to Title Case. *  * @param {string} str The input string to convert. * @returns {string} The Title Cased string, or 'Uncategorized' if the input is empty. *// *  *  * Converts a string to kebab - case (lowercase, spaces replaced with hyphens). * @param {string} str The string to convert. * @returns {string} The kebab - cased string. *// *  *  * Converts a string to Sentence case (capitalizes the first letter). * @param {string} str The string to convert. * @returns {string} The Sentence - cased string. *//  / = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = // MENU, SETUP, AND FORMATTING // = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = / *  *  * Creates the custom UI menu when the spreadsheet is opened. * Merges Markdown Generator and Custom Formatting functionality. *// *  *  * Creates the 'Config' sheet with default settings and descriptions. * Automatically applies standard formatting after creation. *// *  *  * Creates a sample data sheet with columns that exactly match the default JSON configuration. *  * @throws {Error} If the configuration cannot be loaded to determine the sheet name. *// *  *  * Main formatting function that applies all formatting rules to every sheet. *// *  *  * Applies a standard set of formatting rules to a given sheet. * This is a reusable helper function. *  * @param {GoogleAppsScript.Spreadsheet.Sheet} sheet The sheet object to format. * @param {boolean} shouldResizeColumns If true, resizes all columns to 100px. *// / Main Functions
...
function applyStandardFormatting(sheet, shouldResizeColumns) {
  ...
  sheet.setFrozenRows(1); // Optionally resize all columns to 100 pixels;
...
function batchUpdateSheet(sheet, updates, config, colMap) {
  ...
  const statusColIdx = config.statusColumn ? colMap[config.statusColumn] : - 1; // Perform individual updates as ranges may not be contiguous;
...
function createColumnMap(headers, customMapping) {
  const map = {};
  const reverseMapping = {}; // Create a reverse map for easier lookup;
...
function createConfigTemplate() {
  ...
  configSheet.getRange(1, 1, configData.length, 3).setValues(configData); // Apply standard formatting first;
  applyStandardFormatting(configSheet, false); // `false` to skip column resize // Apply specific formatting for this sheet
...
function createFile(filename, content, config, row, colMap, folderCache) { // Use the cached parent folder object for this run;
  ...
  let parentFolder = folderCache.parent; // Handle subfolder logic;
  if (config.subfolderColumn) {
    const subfolderName = row[colMap[config.subfolderColumn]] || 'Uncategorized';
    const folderKey = toTitleCase(subfolderName); // Use the cache if this subfolder has been seen before in this run;
  ...
  const fullName = sanitized + extension; // Simplified duplicate check: Overwrite if exists.;
...
function createSampleDataSheet() {
  ...
  const dataSheet = ss.insertSheet(dataSheetName); // Headers now match all fields in the updated DEFAULT_YAML_FIELDS constant.;
  const sampleHeaders = [;
  ...
  dataSheet.getRange(1, 1, sampleData.length, sampleData[0].length).setValues(sampleData); // Insert checkboxes in the 'processed' column;
  ...
  applyStandardFormatting(dataSheet, false); // `false` to skip column resize // Apply specific auto - sizing for this sheet's content
...
function generateContent(row, colMap, config) {
  ...
  if (config.yamlFields) {
    ...
    Object.entries(config.yamlFields).forEach(([key, colName]) = > {
      ...
      if (value = = = null || value = = = undefined || value = = = '') return; // Rule: Format dates as yyyy - MM - dd;
      ...
      let isList = valueStr.includes(','); // For lists, format each item individually. For single values, create a temporary list to use the same logic.;
      ...
      const formattedItems = items.map(item = > {
        switch (yamlKey) {
          ...
          case 'topic':
          case 'subtopic':
            return toKebabCase(item); // Rule: No changes for filename, aliases, and tags;
          case 'filename':
          case 'aliases':
          case 'tags':
          default:
...
function generateMarkdownFiles() {
  try {
    ...
    const ss = SpreadsheetApp.getActiveSpreadsheet(); // Use the sheet name from the config, or fall back to a default;
    ...
    ensureStatusColumn(dataSheet, config); // Initialize a cache for this run to hold Drive folder objects
    const folderCache = {
      parent: null,
      subfolders: {}
    };
    ...
    Logger.log(`Completed! Created: ${results.created}, Errors: ${results.errors}`);
...
function generateSection(section, row, colMap, config) {
  ...
  const headerPrefix = '#'.repeat(parseInt(sectionHeaderLevel, 10)); // Process title - can include variables like ${filename}
  ...
  switch (section.type) {
    ...
    case 'bullet': // This type creates a heading and a single empty bullet point as a placeholder.
      sectionContent + = ' - \n';
      break;
...
function getOrCreateSubfolder(parentFolder, name) {
  ...
  Logger.log(`Creating new subfolder: "${name}"`);
...
function processDataSheet(sheet, config, folderCache) {
  ...
  for (let i = 1; i < data.length; i + + ) { // Check if the "processed" column exists and if the checkbox is checked (true);
  ...
  Logger.log(`Processing ${rowsToProcess.length} of ${unprocessedRows.length} unprocessed rows...`);
  ...
  if (batchSize && unprocessedRows.length > rowsToProcess.length) {
    ...
    Logger.log(`${remaining} rows remaining. Run the script again to process the next batch.`);
  }
