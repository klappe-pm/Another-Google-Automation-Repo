/**
 * Title: Calendar Analysis Duration and Distance
...
/*
Script Summary:
- Purpose: Export and analyze calendar events with comprehensive duration and date metrics
- Description: Retrieves events from all calendars and calculates various time-based analytics
- Problem Solved: Provides detailed calendar analytics for productivity and time management analysis
- Successful Execution: Creates detailed spreadsheet with events and comprehensive time-based metrics
*/
