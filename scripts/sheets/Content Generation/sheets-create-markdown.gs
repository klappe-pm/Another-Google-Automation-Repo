/**
 * Title: Google Sheets to Markdown File Generator
...
/*
Script Summary:
- Purpose: Automates the generation of markdown (.md) files from Google Sheets data
- Description: Configuration-driven script that creates markdown with YAML frontmatter and custom formatting
- Problem Solved: Enables automated content publishing from spreadsheet data to markdown-based systems
- Successful Execution: Creates organized markdown files with proper formatting and subfolder organization
...
- Batch processing support to avoid timeouts
- Performance optimized with resource caching
- Standardized sheet formatting for newly created tabs
