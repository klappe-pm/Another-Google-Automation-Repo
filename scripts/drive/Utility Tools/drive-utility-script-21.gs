 ...
 * @OnlyCurrentDoc
 *
 * GOOGLE SHEETS ROWS TO MARKDOWN FILE GENERATOR
 * ============================================
 *
 * PURPOSE:
 * This script automates the generation of markdown (.md) files from Google Sheets data.
 * It also includes functions to apply consistent formatting to sheets.
 *
 * KEY FEATURES:
