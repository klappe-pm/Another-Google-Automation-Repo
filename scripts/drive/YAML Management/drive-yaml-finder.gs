/**
 * Title: Drive YAML Frontmatter Finder
 * Service: Google Drive
 * Purpose: Search and extract YAML frontmatter from text files in Drive folders
 * Created: 2024-01-15
 * Updated: 2025-07-16
 * Author: Kevin Lappe
...
/*
Script Summary:
- Purpose: Find and analyze YAML frontmatter in markdown and text files
- Description: Provides custom Google Sheets menu to search Drive folders for files with YAML frontmatter, extract and parse the metadata
- Problem Solved: Manual searching and analysis of YAML frontmatter across multiple files
- Successful Execution: Creates organized listing of files with their YAML frontmatter data extracted and logged
- Dependencies: Google Drive API, Google Sheets API
- Features:
  - Custom UI menu in Google Sheets
  - Dialog box for inputting folder ID or name
  - Text file search within specified folders
  - YAML frontmatter extraction and parsing
  - Comprehensive error handling and user feedback
  - Extensive debugging logs
- Note: Uses custom YAML parser; for complex YAML structures consider external libraries
*/
